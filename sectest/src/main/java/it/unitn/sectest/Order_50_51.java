...
public class Order_50_51 extends BaseTest {
	
	@Test 
	
	public void testOrder_50_51() {
		

		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in vatValue
        ...
        // XSS insertion in vat value
	    
	    WebElement vatValue= driver.findElement(By.id("vatValue"));
	    String vector= "1\"><button>zero vat</button><input type=\"hidden";
	    
	    JavascriptExecutor jse = (JavascriptExecutor) driver;
	    jse.executeScript("arguments[0].setAttribute('value', arguments[1])", vatValue, vector);
		...
		WebElement vatVal= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[4]/div[5]/div[1]/button[1]"));
		String strng = vatVal.getText();
		assertEquals(strng, vatVal.getText());	
