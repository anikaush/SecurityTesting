...
public class Order_37_39 extends BaseTest {
	
	@Test 
	
	public void testOrder_37_39() {
	
			
		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in TotalValue
	    ...
	    WebElement total= driver.findElement(By.id("totalValue1"));
	    String xss= "1\"><button>free</button><input type=\"hidden";
	    
	    
	    JavascriptExecutor jse = (JavascriptExecutor) driver;
	    jse.executeScript("arguments[0].setAttribute('value', arguments[1])", total, xss);
		...
		WebElement totalVaule= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/table[1]/tbody[1]/tr[1]/td[5]/button[1]"));
		String strng = totalVaule.getText();
		assertEquals(strng, totalVaule.getText());	
