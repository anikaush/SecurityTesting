...
public class Order_52 extends BaseTest {
	
	@Test 
	
	public void testOrder_52() {
		
		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in GST
		...
		WebElement edBtn=driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/div[2]/table[1]/tbody[1]/tr[1]/td[7]/div[1]/ul[1]/li[1]/a[1]"));
		edBtn.click();
		
	    WebElement gstn = driver.findElement(By.id("gstn"));
	    gstn.clear();
	    gstn.sendKeys("1\"><button>zero vat</button>");
	    
	    Select payStaus = new Select(driver.findElement(By.id("paymentStatus")));
	    payStaus.selectByVisibleText("No Payment");
	    
	    WebElement saveChangeBtn = driver.findElement(By.id("editOrderBtn"));
	    saveChangeBtn.click();
		...
		WebElement mngOrder= driver.findElement(By.xpath("/html[1]/body[1]/nav[1]/div[1]/div[2]/ul[1]/li[5]/ul[1]/li[2]/a[1]"));
		mngOrder.click();
		...
		WebElement gstnbtn= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[4]/div[6]/div[1]/button[1]"));
		String strng = gstnbtn.getText();
		assertEquals(strng, gstnbtn.getText());	
	    
		
		//Reset by deleting the order
		
		WebElement odrBtn= driver.findElement(By.xpath("/html[1]/body[1]/nav[1]/div[1]/div[2]/ul[1]/li[5]/a[1]/span[1]"));
		odrBtn.click();
									
		WebElement mngeOrder= driver.findElement(By.xpath("/html[1]/body[1]/nav[1]/div[1]/div[2]/ul[1]/li[5]/ul[1]/li[2]/a[1]"));
		mngeOrder.click();
									
		WebElement actnBtn=driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/div[2]/table[1]/tbody[1]/tr[1]/td[7]/div[1]/button[1]/span[1]"));
		actnBtn.click();
