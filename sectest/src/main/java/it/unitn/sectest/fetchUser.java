...
@Test
    ...
    WebElement user=driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/table[1]/tbody[1]/tr[3]/td[1]/h1[1]"));
    String strng = user.getText();
	assertEquals(strng, user.getText());
	
	//Reset
	
	WebElement action=driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/table[1]/tbody[1]/tr[3]/td[2]/div[1]/button[1]/span[1]"));
	action.click();
	
	WebElement remove=driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/table[1]/tbody[1]/tr[3]/td[2]/div[1]/ul[1]/li[2]/a[1]"));
	remove.click();
