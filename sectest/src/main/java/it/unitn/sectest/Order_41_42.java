...
public class Order_41_42 extends BaseTest {
	
	@Test 
	
	public void testOrder_41_42() {
		

		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in SubTotal
        ...
        // XSS insertion in SubTotal
	    
	    WebElement subValue= driver.findElement(By.id("subTotalValue"));
	    String vector= "1\"><button>zero</button><input type=\"hidden";
	    
	    JavascriptExecutor jse = (JavascriptExecutor) driver;
	    jse.executeScript("arguments[0].setAttribute('value', arguments[1])", subValue, vector);
		...
		WebElement subTotal= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[4]/div[1]/div[1]/button[1]"));
