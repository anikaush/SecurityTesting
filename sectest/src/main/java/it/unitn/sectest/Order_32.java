...
public class Order_32 extends BaseTest {
	
	@Test 
	
	public void testOrder_32() {
		
		
		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in Available quantity
	    ...
	    WebElement availquantity= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]/p[1]"));
	    String xss= "1\"><button>null</button><input type=\"hidden";
	    
	    JavascriptExecutor jse = (JavascriptExecutor) driver;
	    jse.executeScript("arguments[0].setAttribute('value', arguments[1])", availquantity, xss);	
		...
		editBtn.click();
		 ...
		 WebElement avail= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/table[1]/tbody[1]/tr[1]/td[3]/div[1]/p[1]"));
		 String strng = avail.getText();
		 assertEquals(strng, avail.getText());	
