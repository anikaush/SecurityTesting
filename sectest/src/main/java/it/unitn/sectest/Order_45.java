...
public class Order_45 extends BaseTest {
	
	@Test 
	
	public void testOrder_45() {
		
		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in Discount
	    ...
	    discount.sendKeys("1\"><button>xss</button>");
		...
		WebElement discountText= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[4]/div[3]/div[1]/button[1]"));
		String strng = discountText.getText();
		assertEquals(strng, discountText.getText());	
