...
public class Order_46_47 extends BaseTest {
	
	@Test 
	
	public void testOrder_46_47() {
		

		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in GrandTotal
	    ...
	    WebElement grandTotal= driver.findElement(By.id("grandTotalValue"));
	    String vector= "1\"><button>Take it for Free</button><input type=\"hidden";
	    
	    JavascriptExecutor jse = (JavascriptExecutor) driver;
	    jse.executeScript("arguments[0].setAttribute('value', arguments[1])", grandTotal, vector);
		...
		WebElement gTotal= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[4]/div[4]/div[1]/button[1]"));
		String strng = gTotal.getText();
		assertEquals(strng, gTotal.getText());	
