...
public class Order_6 extends BaseTest {
	
	final static String BASE_URL = "http://localhost/inventory-management-system/orders.php?o=editOrd&i=86";
	...
	public void testOrder_6() {
		...
		//2. Go to add order
		//3. create an order
		//4. Go to edit order and now insert the XSS in Url
		//5. Assertion
		...
		editBtn.click();
		 ...
		 //Insert XSS in URL
		 driver.get(BASE_URL+"><img src= X>");		
		 
		
		 // 5. Assertion
		 
		 WebElement img= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/h4[1]/img[1]"));
		 String strng = img.getText();
		 assertEquals(strng, img.getText());	
