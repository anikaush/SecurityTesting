...
public class Order_54_55 extends BaseTest {
	
	@Test 
	
	public void testOrder_54_55() {
		

		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in Due Value
        ...
        // XSS insertion in due value
	    
	    WebElement dueValue= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[5]/div[2]/div[1]/input[2]"));
	    String vector= "1\"><button>zero</button><input type=\"hidden";
	    
	    JavascriptExecutor jse = (JavascriptExecutor) driver;
	    jse.executeScript("arguments[0].setAttribute('value', arguments[1])", dueValue, vector);
		...
		WebElement dueVal= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[5]/div[2]/div[1]/input[2]"));
		String strng = dueVal.getText();
		assertEquals(strng, dueVal.getText());	
