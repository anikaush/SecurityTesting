...
public class Order_22 extends BaseTest {
	
	@Test
	public void testOrder_22() { 
		
		//To do list
		//1. login as admin
		//2. go to orders
		//3. go to add orders
		//4. insert xss in client contact
		//6. Assert
		...
		WebElement clientContact=driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/div[2]/table[1]/tbody[1]/tr[1]/td[4]/h1[1]"));
		String expectedcliContact = cliContact.getText();  
					
		assertEquals(expectedcliContact,clientContact.getText());
