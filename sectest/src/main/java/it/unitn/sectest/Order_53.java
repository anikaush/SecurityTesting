...
public class Order_53 extends BaseTest {
	
	@Test 
	
	public void testOrder_53() {
		
		//To Do List
		//1. login as admin
		//2. Go to add order
		//3. create an order: insert XSS in paid
	    ...
	    paidAmount.sendKeys("0\"><button>xss</button>");
		...
		WebElement discountText= driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[2]/form[1]/div[5]/div[1]/div[1]/button[1]"));
